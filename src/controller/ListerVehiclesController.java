...
/**
 * Servlet implementation class ListerVehiclesController
 */
@WebServlet("/vehicle/list")
public class ListerVehiclesController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListerVehiclesController() {
        super();
